-- ============================================================
-- Nahla Cake Panel — Finance Phase 10 (payroll architecture:
-- employees, rates, periods, records, advances, piece_work +
-- ledger link columns + RLS). Run in Supabase SQL Editor.
-- ============================================================
