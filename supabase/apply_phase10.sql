-- ============================================================
-- Nahla Cake Panel — Phase 10 database changes
-- Run in Supabase SQL Editor. Safe to run once (idempotent).
-- (finance-attachments bucket also created via API; insert is a no-op if it exists.)
-- ============================================================
